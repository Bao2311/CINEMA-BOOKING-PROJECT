...
const SettingsTab: React.FC<SettingsTabProps> = ({
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    if (!passwordRegex.test(passwordForm.newPassword)) {
      showAlert(
        "error",
        "Mật khẩu phải từ 8-50 ký tự, bao gồm chữ thường, chữ hoa, số và ít nhất 1 ký tự đặc biệt."
      );
      return;
    }
    try {
      ...
      // Handle API error messages correctly
      if (axios.isAxiosError(error) && error.response) {
        ...
        // If we can extract a specific error message, show it
        if (errorMessage) {
              ...
              {(
                ...
                switch (key) {
                  case "emailNotifications":
                    ...
                    description =
                      "Nhận thông tin đặt vé, khuyến mãi, cập nhật hệ thống qua email.";
                    break;
                  case "smsNotifications":
                    label = "Thông báo qua SMS";
                    description =
                      "Nhận thông tin đặt vé, mã OTP, cảnh báo quan trọng qua SMS.";
                    break;
                  case "marketingCommunications":
                    label = "Khuyến mãi & Ưu đãi";
                    description =
                      "Nhận thông tin về các chương trình khuyến mãi, phim mới.";
                    break;
                  case "bookingReminders":
                    label = "Nhắc nhở lịch chiếu";
                    description =
                      "Nhận thông báo nhắc nhở trước giờ chiếu phim.";
                    break;
                  case "specialOffers":
                    label = "Ưu đãi đặc biệt";
                    description =
                      "Nhận thông báo về các ưu đãi dành riêng cho thành viên.";
                    break;
                }
                return (
                  <div
                  ...
                  >
                    ...
                    <div className="relative inline-block w-10 align-middle select-none transition duration-200 ease-in">
                      ...
                      >
                        <span
                          className={`block w-4 h-4 rounded-full bg-white shadow transform transition-transform duration-200 ease-in-out mt-1 ml-1 ${
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Xem cách chúng tôi thu thập và sử dụng dữ liệu của bạn.
                      </p>
                    </div>
                    <a
                      href="/privacy-policy"

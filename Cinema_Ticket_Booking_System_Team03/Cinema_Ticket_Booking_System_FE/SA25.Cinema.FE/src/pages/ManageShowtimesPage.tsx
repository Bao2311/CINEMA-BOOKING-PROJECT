...
//       // Lấy thêm thông tin về phim và phòng chiếu
//       const showtimesWithDetails = await Promise.all((data['$values'] || []).map(async (showtime) => {
...
//                               </div>
//                               {/* <div>
//                                 <p className="text-sm text-gray-500">Loại giá</p>
//                                 <div className="flex mt-1 space-x-2">
//                                   <button
//                                     type="button"
//                                     onClick={() => setNewShowtime({ ...newShowtime, price_Tier: 'Regular' })}
//                                     className={`px-3 py-1 text-xs rounded-full transition-all ${
//                                       newShowtime.price_Tier === 'Regular'
...
//                                   <button
//                                     type="button"
//                                     onClick={() => setNewShowtime({ ...newShowtime, price_Tier: 'VIP' })}
//                                     className={`px-3 py-1 text-xs rounded-full transition-all ${
//                                       newShowtime.price_Tier === 'VIP'
...
//                               newShowtime.price_Tier === 'VIP' ? 'text-yellow-600' : 'text-blue-600'
//                             }`}>
//                               {newShowtime.price_Tier}
//                             </p>
//                           </div> */}
//                         </div>
//                       </div>
...
//                         {/* <td className="px-6 py-4 whitespace-nowrap">
//                           <span className={`inline-block px-2 py-1 text-xs rounded-full ${
//                             showtime.price_Tier === 'VIP' 
//                               ? 'bg-yellow-100 text-yellow-800' 
//                               : 'bg-blue-100 text-blue-800'
//                           }`}>
//                             {showtime.price_Tier || 'Regular'}
//                           </span>
//                         </td> */}
//                         <td className="px-6 py-4 whitespace-nowrap">
...
//                         <div className="text-xs text-gray-500 mt-1">
//                           Thời lượng: {calculateDuration(viewingShowtime.start_Time, viewingShowtime.end_Time)}
//                         </div>
//                       </div>
//                     </div>
...
//                       <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
//                         <span className="text-gray-800 font-medium">
//                           {viewingShowtime.capacity_Available !== undefined ? viewingShowtime.capacity_Available : 'Không có thông tin'}
//                         </span>
//                       </div>
//                     </div>
//                   </div>
...
//                 Bạn có chắc chắn muốn xóa lịch chiếu này không? Hành động này không thể hoàn tác.
//               </p>
//               <div className="flex justify-center space-x-3">
//                 <button 
//                   onClick={() => setShowDeleteModal(false)} 
//                   className="px-6 py-2.5 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors shadow-sm"
//                 >
//                   Hủy
//                 </button>
//                 <button 
//                   onClick={confirmDelete} 
//                   className="px-6 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors shadow-sm"
//                 >
